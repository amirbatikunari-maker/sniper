...
if (-not $env:SNIPER_WORK_ORIGINS) { $env:SNIPER_WORK_ORIGINS='https://gichul-viewer.pages.dev,https://sniper.pages.dev,http://localhost:5500,http://127.0.0.1:5500' }
...
Write-Host 'sniper WORK Local Agent v16'
