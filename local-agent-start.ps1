...
if (-not $env:SNIPER_WORK_ORIGINS) { $env:SNIPER_WORK_ORIGINS='https://sniper-web.pages.dev,https://gichul-viewer.pages.dev,http://localhost:5500,http://127.0.0.1:5500' }
